...
<head>
    <link type="text/css" rel="stylesheet" href="<c:url value="../resources/shiro.css"/>"/>
</head>

<body>

<div id="contentBox">
    <img src="<c:url value="../resources/logo.png"/>" style="margin-top:20px; border:0"/><br/>
    ...
    <p>
        Click <a href="<c:url value="/home/logout"/>">here</a> to logout.
    </p>
</div>
</body>
</html>